package com.zlyc.www.widget.myTabLayout;/*
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabMarginBottom = a.getDimensionPixelSize(R.styleable.TabLayout_tabMarginBottom, 0);
...
//            }
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                if (mTabLineOffset == 0 && mTabMarginBottom == 0) {
                    canvas.drawRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
                            mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                } else if(mTabLineOffset == 0 && mTabMarginBottom != 0){
                    canvas.drawRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight- mTabMarginBottom,
                            mIndicatorRight, getHeight()- mTabMarginBottom, mSelectedIndicatorPaint);
                }else {
                    ...
                    RectF oval3 = new RectF(
                            tabCenter - mTabLineOffset,
                            getHeight() - mSelectedIndicatorHeight - mTabMarginBottom,
                            mIndicatorRight - width / 2 + mTabLineOffset,
                            getHeight() - mTabMarginBottom);
...
//                    canvas.drawRect(oval3,mSelectedIndicatorPaint);
    ...
    public void setMyStyle(final ViewPager viewPager, List<String> titles){
