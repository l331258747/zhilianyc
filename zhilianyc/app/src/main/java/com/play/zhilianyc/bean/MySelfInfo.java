package com.play.zhilianyc.bean;

import android.text.TextUtils;

import com.play.zhilianyc.bean.login.LoginInfoModel;
import com.play.zhilianyc.bean.login.LoginModel;
import com.play.zhilianyc.util.GsonUtil;
